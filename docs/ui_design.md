...
Quick reference for implementing consistent UI layouts in StrataForge features. For comprehensive patterns, see `ui-design-patterns.md`.

## Page Types

StrataForge features have four main page types:
